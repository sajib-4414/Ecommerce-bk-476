...
urlpatterns = [
    ...
    path('products-by-search-keywords/<str:keywords>/', views.ProductListBySearchKeywordsAPIView.as_view()),
    path('products-by-seller/<int:seller_id>/', views.ProductListBySellerAPIView.as_view()),
